...
export const equipmentOptions: EquipmentOption[] = [
  ...
  {
    id: "switch-panel-12v",
    optionName: "Switch Panel — 12V TM Pre-Wire with Plugs + 12V Battery Tray",
    description: "Complete 12-volt trolling motor pre-wire setup with switch panel and battery tray.",
    price: 185,
    category: "electrical",
    sortOrder: 1,
    applicableModelIds: ["stumpnocker-144-skiff-tiller", "stumpnocker-164-skiff-tiller", "stumpnocker-174-skiff-tiller"],
  },
  {
    id: "switch-panel-24v",
    optionName: "Switch Panel — 24V 6-Gauge with 300 Amp Breaker, Plugs + 12V Battery Tray (x2)",
  ...
  },
  {
    ...
    description: "Required for operation between sunset and sunrise.",
    price: 273,
    category: "electrical",
    sortOrder: 3,
    applicableModelIds: ["stumpnocker-144-skiff-tiller", "stumpnocker-164-skiff-tiller", "stumpnocker-174-skiff-tiller"],
  },
  {
    ...
    description: "Automatic bilge pump for 12-volt systems.",
    price: 240,
    category: "electrical",
    sortOrder: 4,
    applicableModelIds: ["stumpnocker-144-skiff-tiller", "stumpnocker-164-skiff-tiller", "stumpnocker-174-skiff-tiller"],
  },
  {
    ...
    description: "Automatic bilge pump for 24-volt systems.",
    price: 245,
    category: "electrical",
    sortOrder: 5,
    applicableModelIds: ["stumpnocker-144-skiff-tiller", "stumpnocker-164-skiff-tiller", "stumpnocker-174-skiff-tiller"],
