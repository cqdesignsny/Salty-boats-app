...
export function MotorSelect({
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Choose from our Suzuki outboard motors.
                </p>
              </div>
            </div>
          </button>
          ...
          <>
            <div className="border-t border-slate-200 pt-6 mb-4">
              ...
              <p className="text-xs text-slate-400 mb-4 italic">
                Motors do not come installed. Installation is available on the next step.
              </p>
            </div>
            ...
            <div className="bg-ocean/5 rounded-xl p-4 border border-ocean/20 mt-6">
              <p className="text-sm text-navy">
                <span className="font-semibold">Pick Your Power:</span> Motor price is added to your build total. Motors do not come installed — you can add installation on the next step.
              </p>
            </div>
          </>
        )}
    ...
    return (
      <div>
        ...
        <div className="bg-sea-green/10 rounded-xl p-4 border border-sea-green/20 mt-6">
          <p className="text-sm text-navy">
            <span className="font-semibold">All-in package:</span> Motor, trailer, installation, and all equipment included in the price shown. No hidden costs.
          </p>
        </div>
      </div>
    );
  ...
  // ── Stumpnocker: yes/no gate + contact for options ──
  return (
    <div>
      <h2 className="text-2xl font-bold text-navy mb-2">Motor</h2>
      <p className="text-slate-500 mb-6">
        Would you like to purchase a motor with your boat?
      </p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                We carry Yamaha and Suzuki outboard motors.
              </p>
            </div>
          </div>
        </button>
      ...
      {motorOption === "select" && (
        <div className="bg-ocean/5 rounded-xl p-4 border border-ocean/20">
          <p className="text-sm text-navy">
            <span className="font-semibold">Note:</span> Our team will contact you
            after your build request to match the right motor to your boat and
